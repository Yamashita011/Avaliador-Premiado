...
const submitModal = () => {
    ...
    p1.textContent = 'Você acaba de ganhar R$39,72 do Avaliador Premiado por ter respondido a pesquisa, Sua próxima pesquisa será no valor de R$  93,45 Para Produtos Samsung e levará aproximadamente 45 minutos. Se você não tem tempo para responder, por favor não faça a inscrição.';

    const p2 = document.createElement('p');
    p2.setAttribute('class', 'third__pool__description');
    p2.textContent = 'Para liberar o saldo veja as instruções clicando no botão abaixo';
...
const toThirdPool = () => {
    ...
    description.textContent = "Para liberar o app leia as instruções clicando no botão abaixo";
    ...
    buttonText.textContent = "Ler Instruções";
...
const toVideoPage = () => {
    ...
    h3.innerHTML = 'Taxa de <span>Inscrição</span>';

    // Container para a mensagem
    const messageDiv = document.createElement('div');
    messageDiv.setAttribute('class', 'video__page__message');
    messageDiv.setAttribute('style', 'background: #f8f9fa; padding: 2rem; border-radius: 1rem; margin: 2rem 0; text-align: center; border: 2px solid #e9ecef;');

    const messageText = document.createElement('p');
    messageText.setAttribute('style', 'font-size: 1.1rem; line-height: 1.6; color: #495057; margin: 0;');
    messageText.innerHTML = `Para garantir a qualidade e segurança da nossa comunidade, agora é necessário pagar uma pequena taxa de inscrição.<br><br>
    Isso ajuda a evitar contas falsas e manter um ambiente confiável para todos os usuários.<br><br>
    A taxa é simbólica e única, e seu pagamento libera o acesso completo ao app.<br><br>
    ...
    const buttonText = document.createElement('p');
    buttonText.textContent = 'PAGAR TAXA DE INSCRIÇÃO';
    buttonDiv.appendChild(buttonText);
